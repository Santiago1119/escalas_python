...
def get_answers(id_user:int, date:str)->json:
    ...
    with connection_db().cursor() as cursor:
        ...
        try:
            sql = (f"SELECT answer_1, answer_2, answer_3, answer_4, answer_5, answer_6, answer_7, answer_8, answer_9, date, id_answers, doctor_id, user_id FROM answers_phq9 WHERE user_id = %s AND date = %s")  
            value = (id_user, date)
